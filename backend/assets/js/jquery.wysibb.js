...
WBBLANG['fr'] = CURLANG = {
	...
	bullist: "• Listes à puces",
	numlist: "1. LIstes numérotées",
	quote: "Quote",
	offtop: "Offtop",
	code: "Code",
	spoiler: "Spoiler",
	fontcolor: "Couleur du text",
	fontsize: "Taille",
	...
	fs_normal: "Normal",
	fs_big: "Gros",
	fs_verybig: "Très gros",
	smilebox: "Insérer un emoji",
	video: "Insérer une vidéo YouTube",
	removeFormat:"Supprimer le format",
	
	modal_link_title: "Insérer un lien",
	modal_link_text: "Text affiché",
	modal_link_url: "URL",
	modal_email_text: "Email affichée",
	modal_email_url: "Email",
	modal_link_tab1: "Insérer une url",
	
	modal_img_title: "Insérer une image",
	modal_img_tab1: "Insérer l'url",
	modal_img_tab2: "Publier l'image",
	modal_imgsrc_text: "Entrer l'url de l'image",
	modal_img_btn: "Choisir un fichier",
	add_attach: "Ajouter une pièce jointe",
	
	modal_video_text: "Entrer l'url de la vidéo",
	...
	validation_err: "Les données entrées ne sont pas valides.",
	error_onupload: "Erreur durant l'envoie du fichier.",
	
	fileupload_text1: "Déposer le fichier ici",
	fileupload_text2: "ou",
...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,|,img,link,|,fontcolor,fontsize,|,justifyleft,justifycenter,justifyright,|,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				code : {
					...
					onlyClearText: true,
					transform : {
						'<code><pre>{SELTEXT}</pre></code>':"[code]{SELTEXT}[/code]"
					}
				},
				offtop : {
